...
var WebServerComponent = /** @class */ (function () {
    function WebServerComponent(utilsSvc) {
    ...
    WebServerComponent.prototype.initWebServer = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                sslOptions = {
                    key: fs_1.default.readFileSync('./sslKeys/kamli.net/kamli.net.key'),
                    cert: fs_1.default.readFileSync('./sslKeys/kamli.net/_.kamli.net.crt'),
                    ca: [fs_1.default.readFileSync('./sslKeys/kamli.net/GandiStandardSSLCA3.pem')],
                };
                // Start HTTPS server
