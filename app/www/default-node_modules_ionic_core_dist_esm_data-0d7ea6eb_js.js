"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["default-node_modules_ionic_core_dist_esm_data-0d7ea6eb_js"],{
...
/* harmony export */ });
/* harmony import */ var _index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index-cfd9c1f2.js */ 94183);
/*!
...
const warnIfValueOutOfBounds = (value, min, max) => {
  ...
  for (const val of valueArray) {
    if (min !== undefined && isBefore(val, min) || max !== undefined && isAfter(val, max)) {
      (0,_index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_0__.p)('[ion-datetime] - The value provided to ion-datetime is out of bounds.\n\n' + `Min: ${JSON.stringify(min)}\n` + `Max: ${JSON.stringify(max)}\n` + `Value: ${JSON.stringify(value)}`);
      break;
    }
  }
};
...
function parseDate(val) {
  ...
  if (parse === null) {
    ...
    (0,_index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_0__.p)(`[ion-datetime] - Unable to parse date string: ${val}. Please provide a valid ISO 8601 datetime string.`);
    return undefined;
  }
...
//# sourceMappingURL=default-node_modules_ionic_core_dist_esm_data-0d7ea6eb_js.js.map